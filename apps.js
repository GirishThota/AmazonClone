...
rightbtn1.addEventListener('click',function(event){
    const connect=document.querySelector('.product-slide-1');
    connect.scrollLeft+=1100;
    event.preventDefault();
});
...
rightbtn2.addEventListener('click',function(event){
    const connect=document.querySelector('.product-slide-2');
    connect.scrollLeft+=1100;
    event.preventDefault();
});
...
rightbtn3.addEventListener('click',function(event){
    const connect=document.querySelector('.product-slide-3');
    connect.scrollLeft+=1100;
    event.preventDefault();
});
